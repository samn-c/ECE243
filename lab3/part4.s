...
_start:		MOV		SP, #0x20000		// stack pointer
			...
			MOV		R2, #0				// wait register for buttons
...
// Lab 1 Part 4
DIVIDE:     MOV    	R2, #0
CONT:       CMP    	R0, R3         		// modified for modular divisor
            BLT    	DIV_END
            SUB    	R0, R3        	 	// modified for modular divisor
            ADD    	R2, #1
            B      	CONT
